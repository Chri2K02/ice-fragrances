...
export function OGLab() {
  ...
  //
  // set-state-in-effect is the right shape here and the rule is a heuristic:
  // this seeds MUTABLE knob state from browser-only sources exactly once, so
  // useSyncExternalStore (read-only) can't express it, and reading window
  // during render would break SSR of this client component.
